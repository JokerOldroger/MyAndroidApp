...
const infoRows = [
  { label: '用户名', value: 'Cher_111111' },
  { label: '战队', value: '星际机器人小队' },
  { label: '学校', value: 'Future Lab Academy' },
  { label: '邮箱', value: 'cher@example.com' },
];

const skillBars: Array<{ label: string; progress: `${number}%`; color: string }> = [
  { label: '机器人搭建', progress: '88%', color: '#5CC8FF' },
  { label: '图形化编程', progress: '81%', color: '#FF8CA8' },
  { label: '赛场应变', progress: '74%', color: '#FFB84D' },
];

const badges = [
  { title: '本月之星', subtitle: '完成 12 次挑战', icon: require('../../../assets/bisai.png') },
          ...
          <View style={styles.heroCard}>
            <View style={styles.heroTop}>
              <View style={styles.heroCopy}>
                ...
                <Text style={styles.heroTitle}>个人信息站</Text>
                <Text style={styles.heroSubtitle}>看看你的角色资料、成长能力和闪亮奖章</Text>
              </View>
              <Image source={require('../../../assets/touxiang.png')} style={styles.heroSticker} />
            </View>
            ...
            <View style={styles.playerPanel}>
              ...
              <View style={styles.playerInfo}>
                ...
                <Text style={styles.playerMeta}>高级小工程师 · 机器人联赛选手</Text>
                <View style={styles.energyRow}>
                  <View style={styles.energyTrack}>
                    <View style={styles.energyFill} />
                  </View>
                  <Text style={styles.energyText}>能量 92%</Text>
                </View>
              </View>
            </View>
          </View>
