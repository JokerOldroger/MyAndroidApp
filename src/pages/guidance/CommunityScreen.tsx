...
const highlights: Array<{ title: string; detail: string; action: HighlightAction }> = [
  { title: '作品展示', detail: '看看大家最近搭了什么机器人作品。', action: { type: 'screen', target: 'ExchangeIsland' } },
  { title: '练习小组', detail: '和队友一起约训练时间，互相提醒完成任务。', action: { type: 'screen', target: 'Contact' } },
  { title: '技巧讨论', detail: '交流走直线、避障和调参时的发现。', action: { type: 'tab', target: 'AI' } },
];
          ...
          <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            <View style={styles.heroCard}>
              <View style={styles.heroCopy}>
                ...
                <Text style={styles.heroTitle}>交流社区</Text>
                <Text style={styles.heroSubtitle}>在这里分享作品、组队训练、交换机器人比赛小技巧。</Text>
              </View>
              <Image source={require('../../../assets/portrait/好友列表头像.png')} style={styles.heroImage} />
            </View>
