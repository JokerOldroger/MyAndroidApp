...
const achievements = [
  { title: '叮咚直线王', value: '12', color: '#4ED6A7' },
  { title: '编程连胜', value: '9', color: '#FFB84D' },
  { title: '协作之星', value: '6', color: '#73A7FF' },
];
...
const badges: Array<{ label: string; progress: `${number}%` }> = [
  { label: '叮咚搭建', progress: '85%' },
  { label: '程序调试', progress: '72%' },
  { label: '运动控制', progress: '94%' },
];
          ...
          <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            <View style={styles.hero}>
              <View style={styles.heroCopy}>
                <Text style={styles.eyebrow}>DINGDONG LEAGUE</Text>
                <Text style={styles.title}>叮咚成就星球</Text>
                <Text style={styles.subtitle}>查看叮咚训练排名、奖章和本周竞赛能量</Text>
              </View>
              <DingdongLogo size={96} />
            </View>
              ...
              {leaderboard.map((player) => (
                <View key={player.name} style={[styles.rankRow, player.current && styles.currentRank]}>
                  ...
                  <View style={styles.rankInfo}>
                    ...
                    <Text style={styles.rankRole}>{player.current ? '我的排名' : '叮咚挑战者'}</Text>
                  </View>
