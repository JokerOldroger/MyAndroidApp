...
const welcomeMessage = makeAssistantMessage(
  '你好，我是机器人教练 AI。你可以问我搭建、编程、传感器、比赛策略和团队合作，我会用更容易理解的方法陪你学习。'
);
...
export default function AIScreen({ navigation: _navigation }: AIScreenProps) {
  ...
  const [modeLabel, setModeLabel] = useState('训练模式');
          ...
          >
            <View style={styles.hero}>
              <View style={styles.heroCopy}>
                <Text style={styles.heroEyebrow}>ROBOT COACH</Text>
                <Text style={styles.heroTitle}>AI 学习聊天站</Text>
                <Text style={styles.heroSubtitle}>像聊天一样学机器人比赛，小朋友也能轻松问问题</Text>
              </View>
              ...
              {isLoading && (
                <View style={[styles.messageRow, styles.assistantRow]}>
                  ...
                  <View style={[styles.messageBubble, styles.assistantBubble, styles.loadingBubble]}>
                    ...
                    <Text style={styles.loadingText}>教练正在思考中...</Text>
                  </View>
                </View>
              )}
            </ScrollView>
