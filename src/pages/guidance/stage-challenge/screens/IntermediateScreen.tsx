...
export default function IntermediateScreen({ navigation }: IntermediateScreenProps) {
  return (
    <StageLandingTemplate
      ...
      title="中级者"
      subtitle="继续练习判断、循环和更稳定的动作，让叮咚开始像选手一样工作。"
      themeColor="#FFB8D1"
      progress="66%"
      rankLabel="B+"
      missions={[
        { title: '循环巡航', detail: '使用重复指令让叮咚完成固定路线巡航。', reward: '120 XP' },
        { title: '传感器初判断', detail: '让叮咚在看见颜色后再做出不同动作。', reward: '感应贴纸' },
        { title: '结构升级', detail: '把叮咚前部改成更不容易碰歪的结构。', reward: '改装零件' },
      ]}
      skills={[
      ...
      helperTip="如果叮咚表现不稳定，可以先把速度调慢，再重新观察每一步。"
    />
  );
}
