...
import StageLandingTemplate from '../stage-challenge/shared/StageLandingTemplate';
...
export default function ExchangeIslandScreen({ navigation }: ExchangeIslandScreenProps) {
  return (
    <StageLandingTemplate
      ...
      title="交流岛"
      subtitle="分享作品、讨论比赛、交换灵感，这里适合把学习变成一起完成的叮咚冒险。"
      themeColor="#C8A7FF"
      progress="63%"
      rankLabel="TEAM"
      missions={[
        { title: '交流一条技巧', detail: '写下一个你觉得很有用的叮咚搭建或调试小经验。', reward: '交流积分' },
        { title: '点评作品', detail: '看看别人的叮咚设计，并说出一个你喜欢的地方。', reward: '友谊章' },
        { title: '组队挑战', detail: '和伙伴定一个小目标，一起完成一次叮咚练习。', reward: '合作之星' },
      ]}
      skills={[
      ...
      helperTip="当你说出自己和叮咚学到了什么时，记忆会更深，也更容易帮助到队友。"
    />
  );
}
