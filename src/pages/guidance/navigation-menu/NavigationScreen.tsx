...
const quickActions: QuickAction[] = [
  { label: '订阅充值', icon: require('../../../../assets/dingyueguanli.png'), target: 'Subscription', type: 'screen' },
  { label: '卡券', icon: require('../../../../assets/kabao.png'), target: 'Coupon', type: 'screen' },
      ...
      >
        ...
        <View style={styles.profileRow}>
          <Pressable
            ...
            accessibilityLabel="打开叮咚档案"
          >
            <Image source={require('../../../../assets/touxiang.png')} style={styles.avatar} />
          </Pressable>
          <View style={styles.profileTextWrap}>
            <Text style={styles.name}>叮咚学员 Cher</Text>
            <Text style={styles.id}>叮咚ID:111111</Text>
          </View>
          <DingdongLogo size={58} />
        </View>
        ...
        <View style={styles.bottomPanel}>
          ...
          <View style={styles.menuStack}>
            <Pressable
              ...
              accessibilityLabel="打开叮咚档案"
            >
              <Text style={styles.menuText}>叮咚档案</Text>
            </Pressable>
            <Pressable
              style={styles.menuButton}
              onPress={() => navigateToMainTab(navigation, 'Record')}
              accessibilityRole="button"
              accessibilityLabel="打开叮咚战绩"
            >
              <Text style={styles.menuText}>叮咚战绩</Text>
            </Pressable>
            <Pressable
              style={styles.menuButton}
              onPress={() => navigateToMainTab(navigation, 'AI')}
              accessibilityRole="button"
              accessibilityLabel="打开叮咚教练"
            >
              <Text style={styles.menuText}>叮咚教练</Text>
            </Pressable>
            <Pressable
              style={styles.menuButton}
              onPress={() => navigation.navigate('Message')}
              accessibilityRole="button"
              accessibilityLabel="打开叮咚消息站"
            >
              <Text style={styles.menuText}>叮咚消息站</Text>
            </Pressable>
          </View>
        </View>
      </ImageBackground>
