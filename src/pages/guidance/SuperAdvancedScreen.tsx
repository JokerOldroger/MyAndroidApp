...
export default function SuperAdvancedScreen({ navigation }: SuperAdvancedScreenProps) {
  return (
    <StageLandingTemplate
      ...
      badge="SUPER STAGE"
      title="超高级者"
      subtitle="挑战复合任务、比赛策略和高阶自动化，让机器人做出更聪明的判断。"
      themeColor="#7FE4FF"
      progress="91%"
      rankLabel="S+"
      missions={[
        { title: '多传感器联动', detail: '让机器人同时使用颜色与距离判断来完成任务。', reward: '240 XP' },
        { title: '比赛复盘挑战', detail: '分析一次失败回合，找出 2 个可优化点。', reward: '勋章碎片' },
        { title: 'AI 策略训练', detail: '用 AI 教练整理一套终局得分策略。', reward: '高级徽章' },
      ]}
      skills={[
      ...
      helperTip="先让机器人稳定完成，再追求更快更复杂。高阶选手最重要的是稳定性。"
    />
  );
}
